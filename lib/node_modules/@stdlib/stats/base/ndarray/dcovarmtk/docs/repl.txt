...
{{alias}}( arrays )
    ...
    arrays: ArrayLikeObject<ndarray>
        ...
        correction).
        - a zero-dimensional ndarray specifying the mean of the first
        one-dimensional ndarray.
        - a zero-dimensional ndarray specifying the mean of the second
        one-dimensional ndarray.
    ...
    Examples
    --------
    > var x = new {{alias:@stdlib/ndarray/vector/float64}}( [ 1.0, -2.0, 2.0 ] );
    > var y = new {{alias:@stdlib/ndarray/vector/float64}}( [ 2.0, -2.0, 1.0 ] );
