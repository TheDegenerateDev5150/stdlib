...
{{alias}}( [options] )
    Returns a two-dimensional double-precision floating-point ndarray.
...
{{alias}}( shape[, options] )
    Returns a two-dimensional double-precision floating-point ndarray having a
    specified shape.
...
{{alias}}( obj[, options] )
    Creates a two-dimensional double-precision floating-point ndarray from an
...
{{alias}}( buffer[, byteOffset[, shape]][, options] )
    Returns a two-dimensional double-precision floating-point ndarray view of an
    ArrayBuffer.
    ...
    shape: ArrayLikeObject<integer> (optional)
        Array shape. Must contain exactly two elements. If not provided, the
...
{{alias}}( buffer[, byteOffset[, M, N]][, options] )
    Returns a two-dimensional double-precision floating-point ndarray view of an
    ArrayBuffer.

    If `M` and `N` are not provided, the returned ndarray view spans from the
